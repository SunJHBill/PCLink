...
while True:
    ...
    c.close()
'''
To run the host,a directory together with the host named 'serverfile' should be created.The directory should contain a file named 'flist.txt'.When the file list is
